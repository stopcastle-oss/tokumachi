...
export default function TodayStats({ count, isLoading = false }: TodayStatsProps) {
  ...
  if (isLoading) {
    return (
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-6 mb-6 animate-pulse">
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-6 mb-6 border border-blue-100">
      ...
      <div className="flex items-baseline gap-2">
        ...
        <span className="text-lg text-gray-600">{t('home.entriesCount')}</span>
      </div>
    </div>
  );
}
